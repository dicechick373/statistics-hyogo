  ...
  <div>
      ...
      <template v-slot:activator="{ on }">
        ...
        >
          <svg
            ...
            role="img"
            :aria-label="('{title}のグラフをシェア', { title })"
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
    ...
    >
      <div class="Close-Button">
        <v-icon :aria-label="'閉じる'" @click="closeShareMenu">
          {{ mdiClose }}
        </v-icon>
      </div>
      ...
      <div class="Buttons">
        <button :aria-label="'LINEでシェア'" @click="line">
          <picture>
            <source
              srcset="/line.webp"
              type="image/webp"
        ...
        <button :aria-label="'Twitterでシェア'" @click="twitter">
          <picture>
            <source
              srcset="/twitter.webp"
              type="image/webp"
        ...
        <button :aria-label="'facebookでシェア'" @click="facebook">
          <picture>
            <source
  ...
  methods: {
    ...
    twitter() {
      const url = `https://twitter.com/intent/tweet?text=${
        this.title
      }/統計で見る兵庫県のすがた&url=${this.permalink(
        true
      )}&hashtags=StatisticsHyogo`
      window.open(url)
    },
    facebook() {
